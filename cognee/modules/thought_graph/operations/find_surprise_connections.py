...
from ..models.surprise_score import SurpriseScore
from ..algorithms.shortest_path import find_shortest_paths
...
async def find_surprise_connections(
    ...
    try:
        ...
        for source_id, target_id, hop_count, path in transitive:
            # Get node data
