...
async def match_to_projects(
    ...
    """
    logger.info(f"Matching thoughts to projects")
    ...
    try:
        ...
        for thought_id, projects in thought_projects.items():
            ...
            if node_data:
                ...
                # Note: Would need to update node in graph
                # This is a placeholder for the actual update
                logger.debug(f"Would update thought {thought_id} with projects: {all_projects}")
