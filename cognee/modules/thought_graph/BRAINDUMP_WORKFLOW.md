...
```python
from cognee.modules.thought_graph.operations import add_thoughts_batch, enrich_thought_graph
...
**Code Example**:
```python
from cognee.modules.thought_graph.operations import discover_connections
