...
proper configuration for instructor[bedrock] with tools support.
"""
...
class ModelConfig:
    ...
    max_tokens: int
    context_window: int
    recommended_mode: str  # BEDROCK_TOOLS, BEDROCK_JSON, or JSON
...
CLAUDE_MODELS: Dict[str, ModelConfig] = {
    ...
    "anthropic.claude-3-5-sonnet-20241022-v2:0": ModelConfig(
        ...
        recommended_mode="BEDROCK_TOOLS",
    ),
